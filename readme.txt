...
3. 의존성
    ...
    3) 개발 의존성: 개발하는 동안 필요할 때 도움이 되는 패키지 -> 빌드/배포에는 포함 X
...
=== 실습: 설치 ===
$ npm i ejs             [지역, 일반] -> 일반 라이브러리
$ npm i -D nodemon      [지역, 개발] -> 개발 툴 -> 실행/버전확인: $ npx nodemon --version
$ npm i -D -g gulp      [전역, 개발] -> package.json에서는 확인 불가능
